...
router.post("/active-holds", accessControl("qc_hold_material", ["view", "add", "edit"]), getActiveQcHoldParents);
router.post("/list", accessControl("qc_hold_material", "view"), getQcHoldMaterials);
router.post("/get", accessControl("qc_hold_material", "view"), getQcHoldMaterialById);
