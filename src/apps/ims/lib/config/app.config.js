...
export const IMS_APP_CONFIG_DEFINITIONS = Object.freeze([
  ...
  },
  {
    ...
    scope: "ims",
    section: "application",
    label: "QR public lookup URL",
    value_type: "url",
    description: "Public page for printed QRs (e.g. https://jflindia.com/stock_docs). Leave empty to encode plain IDs only.",
  },
  {
...
export const IMS_APP_CONFIG_SEEDS = Object.freeze({
  ...
  [IMS_APP_CONFIG_KEYS.BOX_QR_PUBLIC_BASE_URL]: "https://jflindia.com/stock_docs",
