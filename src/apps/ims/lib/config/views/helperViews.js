...
function fieldsForItems(mod, act) {
  ...
  if (mod === "rm_store_location_master" && act === VIEW) return [...itemPicker];
  if (mod === "rm_store_location_master" && isForm(act)) return [...itemModal];

  if (mod === "rm_spec_master" && act === VIEW) return [...itemPicker];
  if (mod === "rm_spec_master" && isForm(act)) return [...itemModal];
  ...
  if (mod === "shortage" && (act === VIEW || isForm(act))) return [...itemPicker, "grpname"];
...
function fieldsForLedgers(mod, act) {
  ...
  if (mod === "rm_store_location_master" && act === VIEW) return [...ledgerPicker];
  if (mod === "rm_store_location_master" && isForm(act)) return [...ledgerModal];

  if (mod === "rm_spec_master" && act === VIEW) return [...ledgerPicker];
  if (mod === "rm_spec_master" && isForm(act)) return [...ledgerModal];
