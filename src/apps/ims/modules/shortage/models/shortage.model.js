...
/**
 * IMS Shortage — DB layer.
 * SQL lives here (same shape as location / packing-standard models).
 * Business rules (approval workflow, month normalization, grpname lookup) live in the controller.
 */
