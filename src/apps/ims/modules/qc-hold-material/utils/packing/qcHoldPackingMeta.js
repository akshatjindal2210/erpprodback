import { findInHandBoxesByPackingNumber, findDispatchedOutwardLinesByPacking } from "../../../box/models/box.model.js";
import { findForwardedQtyByItemAndPacking } from "../../../forwarding-note/models/forwardingNote.model.js";
import { forwardedTotalQtyForPacking } from "../../../forwarding-note/utils/stock/forwardingAvailableStock.js";
