...
} from "../../../stock-adjustment/models/stockAdjustment.model.js";
import { fetchFromIMS } from "../../../../lib/services/ims.service.js";
import { imsPackRowToProduction, findImsPackByDocNo } from "../../../../lib/utils/erp-api/pack/imsPackRow.js";
import { fetchPackRowsForFinancialYearDoc } from "../../../../lib/utils/erp-api/pack/imsPackFyDoc.js";
import {
  enrichRowsWithIMS,
  resolvePartyRateCustCodeFromIms,
} from "../../../../lib/utils/erp-api/lookup/imsLookup.js";
import { effectiveBoxCustomerAcc } from "../override-customer/boxCustomerOverride.js";
...
export async function resolvePackingStickerMetaForPrint(packing_number, hints = {}) {
  ...
  return {
    ...
    doc_dt: normalizeDocDtForDb(doc_dt) ?? null,
