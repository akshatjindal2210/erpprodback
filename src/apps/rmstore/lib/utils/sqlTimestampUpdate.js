/**
 * TIMESTAMP WITHOUT TIME ZONE updates.
 *
 * Never bind `new Date().toISOString()` into these columns — that stores UTC
 * wall-clock (e.g. 10:09) while `created_at DEFAULT NOW()` stores local IST
 * (e.g. 15:39). Non-null clock fields use SQL NOW() so they match create time.
 *
