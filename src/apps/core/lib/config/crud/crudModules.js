export const CRUD_MODULES = {
  ...
  modules: {
    idField: "id",
    listFields: ["id", "name", "label", "app_type", "sort_order", "is_active", "created_at", "updated_at", "updated_by", "updated_by_name"],
    filterFields: ["id", "name", "label", "app_type", "is_active", "from_date", "to_date"],
  ...
  rm_spec_master: {
    idField: "item_dcode",
    listFields: [
      "sm.item_dcode", "sm.item_code", "sm.item_desc",
      "sm.approved", "sm.approved_by", "sm.approved_at",
      "sm.created_at", "sm.updated_at", "sm.deleted_at",
      "sm.created_by AS created_by_name", "sm.updated_by AS updated_by_name",
      "sm.deleted_by AS deleted_by_name", "sm.approved_by AS approved_by_name",
    ],
    filterFields: ["item_dcode", "spec_type", "approved", "approval_status", "from_date", "to_date"],
    searchFields: ["item_code", "item_desc", "spec_name", "type", "remarks"]
  },
  packing_standard: {
    idField: "standard_id",
    listFields: [ 
  ...
  rm_stock_adjustment: {
    ...
    listFields: [
      "s.adjustment_id", "s.entry_type", "s.item_dcode", "s.item_code", "s.item_desc",
      "s.heat_no", "s.qty", "s.unit", "s.per_coil_qty", "s.coil_count_impact",
      "s.remarks", "s.doc_dt",
    ...
    filterFields: ["adjustment_id", "entry_type", "approved", "from_date", "to_date", "fromDate", "toDate"],
    searchFields: ["s.item_code", "s.item_desc", "s.heat_no", "s.remarks", "s.created_by"]
  },
  stock_adjustment: {
    idField: "adjustment_id",
    listFields: [
