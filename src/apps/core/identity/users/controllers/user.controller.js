...
import config, { getSessionMaxAgeMs } from "../../../../../config/app/config.js";
...
import { setCachedPermissions, clearCachedPermissions } from "../../../../../config/auth/permissionCache.js";
  ...
  try {
    ...
    res.json({
      ...
      data: {
        ...
        designation_name: user.designation_name ?? user.designation?.name ?? null,
        special_permissions,
