...
export const MODULES = {
  ...
  ims: [
    ...
    { name: "invoice_receiving", label: "Invoice Receiving" },
...
export const SEED_MODULES = [
  ...
  { name: "tray_master",                  label: "Tray Master",                     sort_order: 9,        app_type: "ims" },
  { name: "packing_entry",                label: "Packing Entry",                   sort_order: 9,        app_type: "ims" },
  { name: "manage_tray",                  label: "Manage Tray",                     sort_order: 9,        app_type: "ims" },
  ...
  { name: "invoice_receiving",            label: "Invoice Receiving",               sort_order: 41,       app_type: "ims" },
  ...
  { name: "shortage",                     label: "Shortage",                        sort_order: 26,       app_type: "ims" },
  ...
  { name: "rm_mrn_portal",                label: "MRN Entry",                       sort_order: 36,       app_type: "rmstore" },
  ...
  { name: "rm_inventory_audit",           label: "Inventory Audit",                 sort_order: 46,       app_type: "rmstore" },
  { name: "rm_activity_logs",             label: "Activity Logs",                   sort_order: 47,       app_type: "rmstore" },
  { name: "rm_coil_transaction_logs",     label: "Coil Transaction Logs",           sort_order: 48,       app_type: "rmstore" },
  { name: "rm_coil_download_logs",        label: "Sticker Download Logs",           sort_order: 49,       app_type: "rmstore" },
